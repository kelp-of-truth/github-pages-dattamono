<script nonce='dbqmcstnuxj308rko1f6le5avz94ywp27hig'>
	window.onload=function(){document.getElementById('msthdtp').style='display:none;'};
</script>
/*
...
Game.Launch=function()
{
	...
	'<div class="listing">&bull; replaced 繝� in the javascript console building display with more accurate 繝�</div>'+
	...
	Game.Init=function()
	{
		...
		order=1700;Game.TieredAchievement('Hﾍ｡ﾌｸﾌｷﾍ椴ｳﾌｳﾌｯﾌ渭蔑渭栽採｣eﾍ｡ﾌ｢ﾍ侘ｰﾌｦﾌｰﾌｺﾌｮﾌ斛模摸侘ｪﾍ� ﾍ侘�ﾌｦﾍ蔑､ﾌｪﾌ斛�･ﾌｰﾌ�ﾌｫﾌ摸｣ﾍ厠ｬCﾌｨﾌｦﾌｺﾌｩﾌｲﾌ･ﾍ歌ｭﾍ堽慘ｻﾌ變｣ﾌｼﾍ厠ｮﾌｯﾌｪoﾌ｡ﾌｴﾍ槝｡ﾍ�佻捨槊ｲﾍ�ｦﾌｲmﾌｸﾍ侘ｩﾌｺﾌ變｣ﾌｹﾍ�ｱﾍ堽ｬﾌ･ﾌｫﾌｳﾌｼﾌ槊侘ｯeﾍ｢ﾌ箆⇔｣ﾍ�ｺﾌ徭ﾍ佻侘ｶﾍ槊厠淮ｱﾌ･ﾌｮﾌｯﾌｰﾌｦﾍ届�模摸�','','Portal',8);
